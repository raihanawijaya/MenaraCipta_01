...
public class EAdapter extends RecyclerView.Adapter<EAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v;
        v = LayoutInflater.from(mcontext).inflate(R.layout.items_e,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
        ...
        viewHolder.lay_item_e.setOnClickListener(new View.OnClickListener() {
            @Override
