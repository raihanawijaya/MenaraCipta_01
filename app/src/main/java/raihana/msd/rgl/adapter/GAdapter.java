...
public class GAdapter extends RecyclerView.Adapter<GAdapter.MyViewHolder> {
    ...
    //5.Constructor
    public GAdapter(Context mcontext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v;
        v = LayoutInflater.from(mcontext).inflate(R.layout.items_g,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
        ...
        viewHolder.lay_item_g.setOnClickListener(new View.OnClickListener() {
            @Override
