...
public class HAdapter extends RecyclerView.Adapter<HAdapter.MyViewHolder> {
    ...
    //5.Constructor
    public HAdapter(Context mcontext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v;
        v = LayoutInflater.from(mcontext).inflate(R.layout.items_h,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
        ...
        viewHolder.lay_item_h.setOnClickListener(new View.OnClickListener() {
            @Override
