...
import raihana.msd.rgl.adapter.SearchArticleAdapter;
...
public class SearchArticleActivity extends AppCompatActivity {
    ...
    private List<SearchArticleClass> list_detail_search_B = new ArrayList<>();
    private boolean success = false;
    private ConnectionClass connectionClass;
    private SearchArticleAdapter b_detail_search_adapter;
    ...
    public void sync() {
        try{
            ...
            Log.e(SearchArticleActivity.class.getSimpleName(), "sync: ",e );
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_detail_search_B = new ArrayList<SearchArticleClass>();
    ...
    private class SyncData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                if (conn == null) {
                    ...
                    String query = "EXEC DB_A4A292_RGL.dbo.SP_LIST_SEARCH_ARTICLE '" + articleSearch +"'";
                    Log.d("QUERY", query);
                    ...
                    if (rs != null) {
                        ...
                        while (rs.next()) {
                            try {
                                ...
                                list_detail_search_B.add(new SearchArticleClass(rs.getString("ARTICLE"),rs.getString("DESCRIPTION"),rs.getString("BRAND"),rs.getString("PRICE"),rs.getString("STOCK")));
                            } catch (Exception ex) {
                                ex.printStackTrace();
                            }
                        }
        ...
        protected void onPostExecute(String msg) {
            if (success == false) {
                ...
                try {
                    b_detail_search_adapter = new SearchArticleAdapter(list_detail_search_B, SearchArticleActivity.this);
    ...
    public void onChildItemClicked(SearchArticleClass data){
        Intent intent = getIntent();
        intent.putExtra("searchArticle",data.getArticle());
        intent.putExtra("searchPrice",data.getPrice());
