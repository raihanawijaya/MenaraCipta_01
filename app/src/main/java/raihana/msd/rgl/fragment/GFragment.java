...
public class GFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void sync() {
        try{
            ...
            Log.e(GFragment.class.getSimpleName(), "sync: ",e );
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myRecyclerView = v.findViewById(R.id.rv_fragment_g);
        MyAdapter = new GAdapter(getContext());
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                if (conn == null) {
                    ...
                    String query = "EXEC DB_A4A292_RGL.dbo.SP_DAILY_SALES_USER_ID_STORE_STATUS_3 '" + storeCode + "','" + startDate +"','" + endDate + "'";//nah ini tglnya masih dr query blm dari varnya
                    Log.d("QUERY", query);
    ...
    public void onRefresh() {
        try {
            ...
            Log.e(GFragment.class.getSimpleName()
    ...
    public void onStop() {
        try{
            ...
            Log.e(GFragment.class.getSimpleName(), "onStop: Stop Service Failed, because : "+e.getMessage() );
        }
        super.onStop();
    }
}
