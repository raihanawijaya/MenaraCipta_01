...
import raihana.msd.mcp.adapter.AAdapter;
...
public class AFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myRecyclerView = v.findViewById(R.id.rv_fragment);
        MyAdapter = new AAdapter(getContext(), AFragment.this);
...
//            endDate = ((MainActivity)getActivity()).getDate_out2();
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                if (conn == null) {
                    ...
                    String query = "EXEC WIPXP_MNR.[dbo].[SP_ANDROID_LIST_MACHINE_CODE] ";
                    Log.d("QUERY", query);
    ...
    public void setDataToHeaderFragment(final EightColumnClass model){
            new AlertDialog.Builder(getContext())
                    .setTitle("" +  model.getColumn_1()+ "...")
                    .setMessage("Anda Ingin Proses di Mesin " +  model.getColumn_1()+ " ?")
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                          Intent go_to_order = new Intent(getContext(),  WorkOrderForMachineCodeActivity.class);
                           go_to_order.putExtra("MACHINE_CODE",model.getColumn_1());
