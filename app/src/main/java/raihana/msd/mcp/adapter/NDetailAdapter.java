...
public class NDetailAdapter extends RecyclerView.Adapter<NDetailAdapter.MyViewHolder> {
    ...
    //5.Constructor
    public NDetailAdapter(List<EightColumnClass> MyRecordset, Context mcontext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v;
        v = LayoutInflater.from(mcontext).inflate(R.layout.items_n_detail,viewGroup,false);
       ...
       // viewHolder.tv_column_1.setText(EightColumnClass.getColumn_1());
        ...
        viewHolder.lay_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mcontext instanceof Activity_N_Detail)
                    ((Activity_N_Detail) mcontext).setDataToBatalan(EightColumnClass);
            }
        });
