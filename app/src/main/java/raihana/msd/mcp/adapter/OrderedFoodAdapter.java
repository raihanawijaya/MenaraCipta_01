...
public class OrderedFoodAdapter extends RecyclerView.Adapter<OrderedFoodAdapter.MyViewHolder> {
    //4. Declaration
    Context mcontext;
    ...
    //5.Constructor
    public OrderedFoodAdapter(List<EightColumnClass> MyRecordset, OrderActivity mcontext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v;
        v = LayoutInflater.from(mcontext).inflate(R.layout.items_ordered_food,viewGroup,false);
        ...
        if (TrxStatus.equals("Y")){
         ...
         viewHolder.lay_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ((OrderActivity) mcontext).onOrderedFoodClicked(EightColumnClass);
            }
        });
