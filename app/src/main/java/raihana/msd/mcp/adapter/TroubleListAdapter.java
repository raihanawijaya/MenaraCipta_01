...
import raihana.msd.mcp.WorkOrderProcessLotIdPrintTroubleActivity;
import raihana.msd.mcp.model.EightColumnClass;

//1. RV Adapter //3.Implement method
public class TroubleListAdapter extends RecyclerView.Adapter<TroubleListAdapter.MyViewHolder> {
    //4. Declaration
    Context mcontext;
    ...
    //5.Constructor
    public TroubleListAdapter(List<EightColumnClass> MyRecordset, Context mcontext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v;
        v = LayoutInflater.from(mcontext).inflate(R.layout.items_trouble_list,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
        ...
        viewHolder.lay_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mcontext instanceof WorkOrderProcessLotIdPrintTroubleActivity)
                    ((WorkOrderProcessLotIdPrintTroubleActivity) mcontext).onChildItemClicked(EightColumnClass);
            }
        });
