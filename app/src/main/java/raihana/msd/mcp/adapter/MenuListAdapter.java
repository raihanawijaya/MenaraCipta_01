...
public class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> {
    ...
    //5.Constructor
    public MenuListAdapter(List<EightColumnClass> MyRecordset, Context mcontext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v;
        v = LayoutInflater.from(mcontext).inflate(R.layout.items_menu_list,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
        ...
        viewHolder.tv_column_2.setText(EightColumnClass.getColumn_1());

        viewHolder.lay_item.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mcontext instanceof OrderActivity)
                    ((OrderActivity) mcontext).setDataToMenuId(EightColumnClass);
            }
        });
