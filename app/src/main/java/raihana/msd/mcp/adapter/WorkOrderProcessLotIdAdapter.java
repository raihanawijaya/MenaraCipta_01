...
public class WorkOrderProcessLotIdAdapter extends RecyclerView.Adapter<WorkOrderProcessLotIdAdapter.MyViewHolder> {
    ...
    //5.Constructor
    public WorkOrderProcessLotIdAdapter(List<EightColumnClass> MyRecordset, Context mcontext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v;
        v = LayoutInflater.from(mcontext).inflate(R.layout.items_work_order_process_lotid,viewGroup,false);
